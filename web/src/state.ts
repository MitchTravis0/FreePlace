...
export const PALETTE_COLORS = 255;
export const EMPTY_PIXEL = 0xff;
export const MAX_PLACEMENTS_PER_AUTHOR = 8;
export const MAX_BAKED_PER_AUTHOR = 65536;
export const POW_TILE_COOLDOWN_SECS = 20;
export const GHOSTKEY_TILE_COOLDOWN_SECS = 2;
